...
\subsection{Symmetry Activity}
	An interesting notion is a symmetry activity heuristic employed by CHAFF and a modified version in MiniSat as branching heuristic,
